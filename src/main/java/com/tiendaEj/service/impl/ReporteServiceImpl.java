...
public class ReporteServiceImpl implements ReporteService {
    ...
    public ResponseEntity<Resource> generaReporte(
        ...
        try {
            ...
            //A partir de aca inicia la respuesta del usuario
            ...
            switch(tipo) {
                case "Pdf", "vPdf" -> {
                    JasperExportManager.exportReportToPdfStream(reporteJasper,
                            salida);
            ...
            //Apartir de aca se realiza la respuesta al usuario
